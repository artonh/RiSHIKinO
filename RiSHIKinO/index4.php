<?php 
    ...
    if(isset($_POST['add']) && !empty($_POST['userid']) && !empty($_POST['userpass']))
            ...
            $sql = "SELECT * FROM perdoruesit where username='$id' and Password='$pass'";
    ...
    <div class="shell">
      ...
      <div class="header">
        ...
        <div class="socials" style="width:500px;left:450px;"> 
            ...
            <a style="visibility: <?php echo $dukja2; ?>" href="<?php echo $linku1; ?>" id="<?php echo $id1;?>"><b><?php echo $var1; ?></b> </a>
      ...
      <div class="main">
        ...
        <section class="content">
          ...
          require 'lidhjamedb.php';
            ...
            $sql = "SELECT * FROM filmat where ZhandrriNje=".$_GET['id']." or ZhandrriDy=".$_GET['id'];
            $retval = mysqli_query($conn, $sql);
        ...
        <aside class="sidebar">
          ...
          <div class="widget">
            <h3 class="widgettitle">Te fundit!</h3>
            <ul>
