      ...
      <div class="main">
        ...
        <aside class="sidebar">
          ...
          <div class="widget socials-widget">
            ...
            <div class="widget socials-widget">
                <h3 class="widgettitle" onclick="loadDoc()"><abbr title="Shtyp per te pare listen komplete" style="text-decoration:none"> Lista komplete:</abbr></h3>
            <ul>
              <li id="demo"><a href="#"></a> </li>
              <li>
            <script>
            function loadDoc() {
              ...
              xhttp.open("GET", "filmatkatalog.xml", true);
              xhttp.send();
            }
            function myFunction(xml) {
              var i;
              var xmlDoc = xml.responseXML;
              var x = xmlDoc.getElementsByTagName("FILMI");
              var table = "";
              for (i = 0; i <x.length; i++) { 
              table += x[i].getElementsByTagName("TITLE")[0].childNodes[0].nodeValue + "<br>";
              }
